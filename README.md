...
@oclif/example-plugin-js/1.3.7 (linux-x64) node-v9.6.1
...
_See code: [src/commands/hello.js](https://github.com/oclif/example-plugin-js/blob/v1.3.7/src/commands/hello.js)_
<!-- commandsstop -->
