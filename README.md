...
@oclif/example-plugin-js/1.3.13 (linux-x64) node-v9.8.0
...
_See code: [src/commands/hello.js](https://github.com/oclif/example-plugin-js/blob/v1.3.13/src/commands/hello.js)_
<!-- commandsstop -->
