...
@oclif/example-plugin-js/1.2.3 (linux-x64) node-v9.5.0
...
_See code: [src/commands/hello.js](https://github.com/oclif/example-plugin-js/blob/v1.2.3/src/commands/hello.js)_
<!-- commandsstop -->
