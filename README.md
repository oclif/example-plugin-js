...
@oclif/example-plugin-js/1.8.5 linux-x64 node-v10.5.0
...
_See code: [src/commands/hello.js](https://github.com/oclif/example-plugin-js/blob/v1.8.5/src/commands/hello.js)_
<!-- commandsstop -->
