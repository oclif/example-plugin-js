...
@oclif/example-plugin-js/1.8.3 linux-x64 node-v10.4.1
...
_See code: [src/commands/hello.js](https://github.com/oclif/example-plugin-js/blob/v1.8.3/src/commands/hello.js)_
<!-- commandsstop -->
