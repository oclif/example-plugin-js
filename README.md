...
@oclif/example-plugin-js/1.7.48 linux-x64 node-v10.2.1
...
_See code: [src/commands/hello.js](https://github.com/oclif/example-plugin-js/blob/v1.7.48/src/commands/hello.js)_
<!-- commandsstop -->
