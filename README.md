...
@anycli/example-plugin-js/0.9.16 (linux-x64) node-v9.5.0
...
_See code: [@anycli/example-plugin-js](https://github.com/anycli/example-plugin-js/blob/v0.9.16/src/commands/hello.js)_
<!-- commandsstop -->
