...
@oclif/example-plugin-js/1.4.9 linux-x64 node-v9.9.0
...
_See code: [src/commands/hello.js](https://github.com/oclif/example-plugin-js/blob/v1.4.9/src/commands/hello.js)_
<!-- commandsstop -->
