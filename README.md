...
@oclif/example-plugin-js/1.7.49 linux-x64 node-v10.3.0
...
_See code: [src/commands/hello.js](https://github.com/oclif/example-plugin-js/blob/v1.7.49/src/commands/hello.js)_
<!-- commandsstop -->
